// Note that this snakes and ladders game took out every ounce of my energy. I
// had to use some reference online because this was killing so much of my time
// (I spent well over 4 hours) so this is a shoutout to them (i love you GfG!). Despite the strain
// in doing this, i had SO much fun doing this!!//
#include <stdio.h>
#include <stdlib.h>
int rd() {
  int rem;
